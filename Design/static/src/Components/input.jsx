...
const Input = (props)=>{
    return (
        <div className="file-input">
            <input type="file" name={props.name} id={props.name} className="file-input__input"  accept={props.accept} onChange={props.change}/>
            <label className="file-input__label" htmlFor={props.name}>
